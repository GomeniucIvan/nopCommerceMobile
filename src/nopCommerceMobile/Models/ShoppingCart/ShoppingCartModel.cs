...
namespace nopCommerceMobile.Models.ShoppingCart
{
    public class ShoppingCartModel : BaseModel
    {
        ...
        public class CheckoutAttributeModel : BaseModel
        {
        ...
        public class CheckoutAttributeValueModel : BaseModel
        {
            public string Name { get; set; }
        ...
        public class DiscountBoxModel : BaseModel
        {
            ...
            public class DiscountInfoModel : BaseModel
            {
                public string CouponCode { get; set; }
            }
        }

        public class GiftCardBoxModel : BaseModel
        {
            public bool Display { get; set; }
