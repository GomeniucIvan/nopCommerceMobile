...
namespace nopCommerceMobile.Models.Customer
{
    ...
    public static class CustomerExtensions
    {
        ...
        public static bool IsInCustomerRole(this CustomerModel customer,
        ...
        /// <param name="customer">Customer</param>
        /// <returns>Result</returns>
        public static bool IsBackgroundTaskAccount(this CustomerModel customer)
        {
            if (customer == null)
                throw new ArgumentNullException(nameof(customer));
        ...
        /// <param name="onlyActiveCustomerRoles">A value indicating whether we should look only in active customer roles</param>
        /// <returns>Result</returns>
        public static bool IsAdmin(this CustomerModel customer, bool onlyActiveCustomerRoles = true)
        {
